...
function App() {
  ...
  const programs = [
    ...
    },
    {
      ...
      image: 'teens-training',
      cta: 'View Teen Training',
    ...
    },
    {
      ...
      image: 'fitness-conditioning',
      cta: 'See Conditioning Plan',
  ...
  return (
    <div className="app-shell relative min-h-screen overflow-x-hidden">
        ...
        <nav className="glass-dark mx-4 mt-4 rounded-2xl px-6 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#00A8FF] to-[#00FFD1] flex items-center justify-center">
            ...
            <div className="hidden md:flex items-center gap-8">
              {[
                ...
                >
                  {item.label}
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#00A8FF] to-[#00FFD1] transition-all duration-300 group-hover:w-full" />
                </button>
              ))}
            </div>
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="section-ambient section-ambient-hero section-panel relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 z-0">
          <div className="hero-bg-image absolute inset-0 scale-110">
            <ResponsiveImage
              name="kids-gymnastics"
              alt="Kids training with a coach"
          ...
          <div className="hero-stats grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {stats.map((stat, index) => (
              <div key={index} className="glass rounded-2xl p-4 text-center">
                <stat.icon className="w-6 h-6 text-[#00A8FF] mx-auto mb-2" />
      ...
      {/* Stats Section */}
      <section ref={statsRef} className="section-padding section-panel section-alt relative">
      ...
      {/* About Section */}
      <section ref={aboutRef} className="section-padding section-panel relative">
            ...
            <div className="about-image relative">
              ...
              <div className="absolute -bottom-6 -right-6 glass rounded-2xl p-6 max-w-xs">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00A8FF] to-[#00FFD1] flex items-center justify-center">
              ...
              {/* Decorative Elements */}
              <div className="absolute -top-4 -left-4 w-24 h-24 border-2 border-[#00A8FF]/30 rounded-2xl -z-10" />
              <div className="absolute -bottom-4 left-1/4 w-16 h-16 bg-[#00A8FF]/10 rounded-full blur-xl" />
            </div>
                ...
                {[
                  ...
                  <div key={index} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#00A8FF]/20 flex items-center justify-center flex-shrink-0">
                      <ChevronRight className="w-4 h-4 text-[#00A8FF]" />
                    </div>
      ...
      {/* Programs Section */}
      <section ref={programsRef} className="section-padding section-panel section-ambient section-ambient-programs section-alt relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="px-3 py-1 rounded-full bg-[#00A8FF] text-black text-xs font-semibold">
                      {program.age}
                    </span>
                  </div>
                </div>
                    ...
                    <DialogContent className="glass-dark border-white/10 max-w-lg">
                      ...
                      <div className="mt-4">
                        <ResponsiveImage
                          ...
                          imgClassName="w-full h-48 object-cover rounded-xl mb-4"
      ...
      {/* Gallery Section */}
      <section ref={galleryRef} className="section-padding section-panel section-ambient section-ambient-gallery section-tight relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Section Header */}
            <div className="text-center mb-16">
              <div className="gallery-preview" aria-hidden="true">
                {galleryPreview.map((image) => (
                  <div key={image} className="gallery-preview-item">
                    <ResponsiveImage
                      name={image}
                      alt=""
                      className="block w-full h-full"
              ...
              <div className="mt-8 flex justify-center">
                ...
                >
                  <span>Join Our Academy Today</span>
                </a>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {galleryImages.map((image, index) => (
              <Dialog key={index}>
                <DialogTrigger asChild>
                  <div
                    className={`gallery-item group relative overflow-hidden rounded-2xl cursor-pointer ${index === 0 || index === 3 ? 'md:col-span-2 md:row-span-2' : ''
                      }`}
                  >
                    <ResponsiveImage
                      name={image}
                      alt={`Gallery ${index + 1}`}
                      className="block w-full h-full"
                      imgClassName="w-full object-cover transition-transform duration-700 group-hover:scale-110"
                      style={{ height: index === 0 || index === 3 ? '400px' : '200px' }}
                      sizes={index === 0 || index === 3 ? "(min-width: 768px) 66vw, 100vw" : "(min-width: 768px) 33vw, 50vw"}
                    />
      ...
      <section ref={testimonialsRef} className="section-padding section-panel section-alt relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="text-center mb-16">
            <span className="section-badge mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                {/* Quote Icon */}
                <div className="absolute -top-4 left-8 w-8 h-8 rounded-full bg-gradient-to-br from-[#00A8FF] to-[#00FFD1] flex items-center justify-center">
                ...
                <div className="flex gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 fill-[#00A8FF] text-[#00A8FF]" />
                  ))}
                </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00A8FF]/30 to-[#00FFD1]/30 flex items-center justify-center">
      ...
      {/* Contact Section */}
      <section ref={contactRef} className="section-padding section-panel relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="text-center mb-16">
            <span className="section-badge mb-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="contact-info space-y-6">
              <div className="glass rounded-3xl p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl bg-[#00A8FF]/20 flex items-center justify-center flex-shrink-0">
                      <Phone className="w-6 h-6 text-[#00A8FF]" />
                    </div>
                    <div>
                      <div className="text-white/50 text-sm mb-1">Phone</div>
                      <a href="tel:+919999999999" className="text-white font-semibold hover:text-white transition-colors">
                        +91 99999 99999
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    {[
                      ...
                      <a
                        key={index}
                        href={social.href}
                        className="w-10 h-10 rounded-full glass flex items-center justify-center text-white/60 hover:text-[#00A8FF] hover:bg-[#00A8FF]/20 transition-all"
                      >
              ...
              {/* CTA Card */}
              <div className="glass rounded-3xl p-8 bg-gradient-to-br from-[#00A8FF]/20 to-[#00FFD1]/20">
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-24 md:bottom-8 right-8 z-50 w-12 h-12 rounded-full bg-gradient-to-br from-[#00A8FF] to-[#00FFD1] flex items-center justify-center text-black shadow-lg transition-all duration-300 ${showScrollTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'
          }`}
      >
